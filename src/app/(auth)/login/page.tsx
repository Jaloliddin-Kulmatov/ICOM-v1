    ...
    <div className="min-h-screen flex items-center justify-center px-4 mesh-gradient dot-grid">
      ...
      <div className="w-full max-w-sm animate-slide-up">
        ...
        <div className="glass-card p-7">
          {/* OAuth — not yet connected */}
          <Button
            variant="outline"
            className="w-full gap-2.5 mb-4 h-11 opacity-60 cursor-not-allowed"
            type="button"
            title="Google login coming soon"
            onClick={() => alert("Google login is coming soon. Please use email and password for now.")}
          >
            ...
            Continue with Google <span className="text-[10px] ml-1 text-muted-foreground">(soon)</span>
          </Button>
